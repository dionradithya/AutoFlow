...
// ===== CARS/MOBILS ENDPOINTS (PATHS CORRECTED) =====
export const getCars = (params = {}) => api.get('/mobils', { params }); // Corrected
export const getCarById = (id) => api.get(`/mobils/${id}`); // Corrected
...
export const deleteCar = (id) => api.delete(`/mobils/${id}`); // Corrected
...
export const createCarJSON = (data) => api.post('/mobils', data); // Corrected

// Alternative car update without FormData (JSON only)  
export const updateCarJSON = (id, data) => api.put(`/mobils/${id}`, data); // Corrected
